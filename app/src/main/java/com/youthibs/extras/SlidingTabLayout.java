...
public class SlidingTabLayout extends HorizontalScrollView {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(mTabViewLayoutId, mTabStrip,
                        false);
                tabTitleView = (ImageView) tabView.findViewById(mTabViewImgViewId);
            ...
            tabTitleView.setImageResource(Integer.parseInt(adapter.getPageTitle(i+4).toString()));
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            ImageView img = (ImageView)selectedTitle.findViewById(R.id.imageView);
            img.setImageResource(Integer.parseInt(mViewPager.getAdapter().getPageTitle(position).toString()));
            alterImg(position);
        ...
        public void alterImg(int position){
            for(int k = 0; k <4; k++){
                if(k!=position){
                    View selectedTitle = mTabStrip.getChildAt(k);
                    ImageView img = (ImageView)selectedTitle.findViewById(R.id.imageView);
                    int resId=Integer.parseInt(mViewPager.getAdapter().getPageTitle(k + 4).toString());
